...
Route::group(['middleware' => "CheckUser"],function(){
    ...
    Route::put('/like',[NewsController::class , 'like']);//in header user_id and news_id
    Route::put('/disLike',[NewsController::class , 'disLike']); //in header user_id and news_id
    Route::get('/getRandomNews',[NewsController::class , 'getRandomNews']);//in header user_id
});
